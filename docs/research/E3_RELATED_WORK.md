...
| Varıcı et al., [Linear Causal Representation Learning from Unknown Multi-node Interventions](https://arxiv.org/abs/2406.05937), 2024 | Gives identifiability results and constructive algorithms for causal representations under unknown multi-node interventions. | E3 uses discrete typed worlds and a bounded transferable artifact; it does not claim general identifiability or reproduce the paper's continuous/linear assumptions. |
| Wang et al., [Building Minimal and Reusable Causal State Abstractions for Reinforcement Learning](https://arxiv.org/abs/2401.12497), 2024 | Causal Bisimulation Modeling learns task-specific abstractions from dynamics and reward and reports sample-efficiency gains. | It is an internal abstraction/model-learning method in manipulation and control environments, not a non-co-trained recipient receiving a byte-bounded executable causal object. |
| Edmonds et al., [Theory-based Causal Transfer](https://arxiv.org/abs/1911.11185), 2019 | Transfers abstract causal structure plus instance-level induction across OpenLock tasks. | This is the closest causal-transfer overlap; E3 differs by independent recipients, sealed procedural shift families, exact packet/resource contracts, and executable causal/sham controls. |
| Deng et al., [Causal Reinforcement Learning: A Survey](https://arxiv.org/abs/2307.01452), 2023 | Surveys causal RL methods and identifies transfer, invariance, and sample efficiency as open concerns. | It motivates E3's scope but is a survey, not a demonstration of the complete E3 conjunction. |
| Ghugare et al., [Closing the Gap Between TD Learning and Supervised Learning](https://arxiv.org/abs/2401.11237), 2024 | Shows that combinatorial stitching/generalization is distinct from IID generalization and can expose failures of supervised baselines. | E3's composition shift and world-level unit test a related generalization concern, while adding intervention-derived packet transfer and recipient/resource gates. |
